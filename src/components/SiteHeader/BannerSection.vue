<template>
  <div class="relative group">
    <div
      ...
      <img class="absolute" style="top: 12%;right: -10%;" src="./../../assets/img/slider/slider-shape-4.png" alt="shape">
    </div>
    <div class="h-screen w-full overflow-hidden flex flex-nowrap text-left relative z-0" id="slider">
      <div class="flex-none w-full flex flex-row-reverse items-center justify-between px-14">
        <div>
          <img src="./../../assets/img/slider/slider-bg-1.png" class="fade-in-right" alt="Slider1" />
        </div>
        <div class="space-y-6 mb-16">
          <p class="uppercase text-verde-custom font-medium fade-in-up delay-1">Top seller in the week</p>
          <h2 class="max-w-xl text-6xl text-indigo-900 font-bold capitalize fade-in-up delay-2">Choose your healthy lifestyle.
          </h2>
          <p class="max-w-lg text-lg text-gray-600 fade-in-up delay-3">Presentation matters. Our fresh Vietnamese
            vegetable rolls look good and taste even better</p>
          <button
            class="bg-verde-custom hover:bg-indigo-900 text-white text-sm font-medium uppercase rounded-3xl px-14 py-3 fade-in-up delay-4">Shop
            now</button>
        </div>
      </div>
      <div class="flex-none w-full flex flex-row-reverse items-center justify-between px-14">
        <div>
          <img src="./../../assets/img/slider/slider-bg-2.png" class="fade-in-right" alt="Slider2"/>
        </div>
        <div class="space-y-6 mb-16">
          <p class="uppercase text-verde-custom font-medium fade-in-up delay-1">Top seller in the week</p>
          <h2 class="max-w-xl text-6xl text-indigo-900 font-bold capitalize fade-in-up delay-2">Fresh bread oatmeal crumble.
          </h2>
          <p class="max-w-lg text-lg text-gray-600 fade-in-up delay-3">Presentation matters. Our fresh Vietnamese
            vegetable rolls look good and taste even better</p>
          <button
      ...
      <div class="flex-none w-full flex flex-row-reverse items-center justify-between px-14">
        <div>
          <img src="./../../assets/img/slider/slider-bg-3.png" class="fade-in-right" alt="Slider3"/>
        </div>
        <div class="space-y-6 mb-16">
          <p class="uppercase text-verde-custom font-medium fade-in-up delay-1">Top seller in the week</p>
          <h2 class="max-w-md text-6xl text-indigo-900 font-bold capitalize fade-in-up delay-2">The best health fresh.
          </h2>
          <p class="max-w-lg text-lg text-gray-600 fade-in-up delay-3">Presentation matters. Our fresh Vietnamese
            vegetable rolls look good and taste even better</p>
          <button
